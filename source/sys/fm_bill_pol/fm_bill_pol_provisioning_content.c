/* continuus file information --- %full_filespec: fm_bill_pol_provisioning_content.c~2:csrc:1 % */
/*******************************************************************
 *
 * @(#)fm_content_authenticate.c 1.0 2001/01/26
 *
...
#ifndef lint
static  char    Sccs_id[] = "@(#)%Portal Version: fm_bill_pol_provisioning_content.c:BillingVelocityInt:2:2006-Sep-05 21:55:08 %";
#endif
