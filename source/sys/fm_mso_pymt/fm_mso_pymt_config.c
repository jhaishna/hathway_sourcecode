...
struct cm_fm_config fm_mso_pymt_custom_config[] = {
	...
	{ MSO_OP_PYMT_COLLECT,	        	"op_mso_pymt_collect", CM_FM_OP_OVERRIDABLE }, 
	...
	{ MSO_OP_PYMT_AUTOPAY,         "mso_pymt_autopay", CM_FM_OP_OVERRIDABLE },
	{ MSO_OP_PYMT_CORRECTION,         "mso_pymt_correction", CM_FM_OP_OVERRIDABLE },
	{ MSO_OP_PYMT_PROCESS_REFUND,         "mso_pymt_process_refund", CM_FM_OP_OVERRIDABLE },
	{ MSO_OP_PYMT_REVERSE_REFUND,         "mso_pymt_reverse_refund", CM_FM_OP_OVERRIDABLE },
	{ MSO_OP_AR_ALLOCATE,         "mso_ar_allocate" },
	/*{ MSO_OP_BILL_ITEM_TRANSFER,         "mso_op_bill_item_transfer" },*/
	{ 0,    (char *)0 }
};
