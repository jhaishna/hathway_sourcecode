...
*--------------------------------------------------------------------------------------------------------------*
* 0.1    |06/07/2015 |Pavan Bellala         |  BB Provisioning : Failed response
*--------------------------------------------------------------------------------------------------------------*
*
****************************************************************************************************************/
...
#ifndef lint
static  char Sccs_Id[] = "@(#)$Id: fm_mso_prov_bb_get_failed_response.c /cgbubrm_7.3.2.rwsmod/1 2009/08/04 23:37:19 pjegan Exp $";
#endif
...
EXPORT_OP void
op_mso_prov_bb_get_failed_response(
...
static void
fm_mso_prov_bb_get_failed_response(
        pcm_context_t           *ctxp,
        pin_flist_t             *in_flistp,
        int32                   flags,
...
/*******************************************************************
 * Main routine for the MSO_OP_PROV_BB_GET_FAILED_RESPONSE command
 *******************************************************************/
void
op_mso_prov_bb_get_failed_response(
        cm_nap_connection_t    *connp,
        ...
        pin_errbuf_t            *ebufp)
{
    ...
    *ret_flistpp = NULL;
     ...
     * Insanity check.
     ***********************************************************/
    if (opcode != MSO_OP_PROV_BB_GET_FAILED_RESPONSE) {
        pin_set_err(ebufp, PIN_ERRLOC_FM,
            PIN_ERRCLASS_SYSTEM_DETERMINATE,
                PIN_ERR_BAD_OPCODE, 0, 0, opcode);
        PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,
            "bad opcode in op_mso_prov_bb_get_failed_response", ebufp);
        return;
    }
    ...
    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
        "op_mso_prov_bb_get_failed_response input flist", in_flistp);

    /***********************************************************
     * Call main function to do it
     ***********************************************************/
    fm_mso_prov_bb_get_failed_response(ctxp, in_flistp, flags, &r_flistp, ebufp);
    ...
    if (PIN_ERRBUF_IS_ERR(ebufp)) 
    {
        *ret_flistpp = (pin_flist_t *)NULL;
        ...
        PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,
            "op_mso_prov_bb_get_failed_response error", ebufp);
    } 
    else 
    {
        *ret_flistpp = r_flistp;
        PIN_ERRBUF_CLEAR(ebufp);
        PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
            "op_mso_prov_bb_get_failed_response return flist", *ret_flistpp);
    }
...
/*******************************************************************
 * fm_mso_prov_get_failed_response()
 *
 *******************************************************************/
static void
fm_mso_prov_bb_get_failed_response(
    ...
    pin_errbuf_t            *ebufp)
{
     ...
     ***********************************************************/
    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
        "fm_mso_prov_bb_get_failed_response input flist", in_flistp);
    ...
    if (PIN_ERRBUF_IS_ERR(ebufp)) {
        PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,
            "fm_mso_prov_bb_get_failed_response error: required field missing in input flist", ebufp);
        return;
    }
    ...
    {
        template = "select X from /mso_failed_prov_response where F1 = V1 ";
    ...
    {
        template = "select X from /mso_failed_prov_response where F1 >= V1 and F2 <= V2 ";
        PIN_FLIST_FLD_SET(search_i_flistp, PIN_FLD_TEMPLATE, (void*)template, ebufp);
    ...
    {
        template = "select X from /mso_failed_prov_response where F1 >= V1 and F2 <= V2 and F3 = V3 ";
        PIN_FLIST_FLD_SET(search_i_flistp, PIN_FLD_TEMPLATE, (void*)template, ebufp);
    ...
    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
        "fm_mso_prov_bb_get_failed_response search input flist ", search_i_flistp);
    PCM_OP(ctxp, PCM_OP_SEARCH, PCM_OPFLG_CACHEABLE, search_i_flistp,
        out_flistpp, ebufp);
    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
        "fm_mso_prov_bb_get_failed_response search output flist", *out_flistpp);
