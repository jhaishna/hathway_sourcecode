...
#ifndef lint
static  char Sccs_Id[] = "@(#)$Id: fm_mso_prov_bb_get_failed_order_detail.c /cgbubrm_7.3.2.rwsmod/1 2009/08/04 23:37:19 pjegan Exp $";
#endif
...
EXPORT_OP void
op_mso_prov_bb_get_failed_order_detail(
...
static void
fm_mso_prov_bb_get_failed_order_detail(
        pcm_context_t           *ctxp,
        pin_flist_t             *in_flistp,
        int32                   flags,
        ...
        pin_errbuf_t            *ebufp)
{
    ...
    *ret_flistpp = NULL;
     ...
     * Insanity check.
     ***********************************************************/
    if (opcode != MSO_OP_PROV_BB_GET_FAILED_ORDER_DETAIL) {
        pin_set_err(ebufp, PIN_ERRLOC_FM,
            PIN_ERRCLASS_SYSTEM_DETERMINATE,
                PIN_ERR_BAD_OPCODE, 0, 0, opcode);
        PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,
            "bad opcode in op_mso_prov_bb_get_failed_order_detail", ebufp);
        return;
    }
    ...
    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
        "op_mso_prov_bb_get_failed_order_detail input flist", in_flistp);


    /***********************************************************
     * Call main function to do it
     ***********************************************************/
    fm_mso_prov_bb_get_failed_order_detail(ctxp, in_flistp, flags, &r_flistp, ebufp);
    ...
    {
        PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,
            "op_mso_prov_bb_get_failed_order_detail error", ebufp);
    ...
    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
         "op_mso_prov_bb_get_failed_order_detail return flist", *ret_flistpp);
    ...
    pin_errbuf_t            *ebufp)
{
     ...
     ***********************************************************/
    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
        "fm_mso_prov_bb_get_failed_order_detail input flist", in_flistp);
    ...
    {
        PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,
            "fm_mso_prov_bb_get_failed_order_detail error: required field missing in input flist", ebufp);
        return;
    }
    ...
    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
        "fm_mso_prov_bb_get_failed_order_detail search input flist ", read_i_flist);
    PCM_OP(ctxp, PCM_OP_READ_OBJ, PCM_OPFLG_CACHEABLE, read_i_flist,
        &read_o_flist, ebufp);
    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
        "fm_mso_prov_bb_get_failed_order_detail search output flist", read_o_flist);
     ...
     */
    fm_mso_prov_bb_get_oap_result(ctxp, read_o_flist, out_flistpp, ebufp);
    if(read_o_flist)
    ...
    pin_errbuf_t            *ebufp)
{
   ...
   /******************************************************
    ...
    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
        "fm_mso_prov_bb_get_oap_result input flist", i_flistp);
    ...
    *ret_flistpp = PIN_FLIST_CREATE(ebufp);
    ...
    PIN_FLIST_FLD_COPY(i_flistp, PIN_FLD_PROGRAM_NAME, *ret_flistpp, PIN_FLD_PROGRAM_NAME, ebufp);
    PIN_FLIST_FLD_COPY(i_flistp, MSO_FLD_TECHNOLOGY, *ret_flistpp, MSO_FLD_TECHNOLOGY, ebufp);
    ...
    { 
        ...
        PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
                "fm_mso_prov_bb_get_oap_result return flist", *ret_flistpp);
        PIN_FLIST_DESTROY_EX(&r_flistp, NULL);
    }
    return;
}
