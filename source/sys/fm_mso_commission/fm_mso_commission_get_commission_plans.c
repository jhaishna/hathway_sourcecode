...
/*******************************************************************
 * File:	fm_mso_commission_get_commission_plans.c
 * Opcode:	MSO_OP_COMMISSION_GET_COMMISSION_PLANS 
 * Description: 
 *
...
#ifndef lint
static const char Sccs_id[] = "@(#)%Portal Version: fm_mso_commission_get_commission_plans.c:CUPmod7.3PatchInt:1:2006-Dec-01 16:31:18 %";
#endif
...
/*******************************************************************
 * MSO_OP_COMMISSION_GET_COMMISSION_PLANS 
 *
 * This policy is used to get the LCO plans and its associated deals
 *******************************************************************/

EXPORT_OP void
op_mso_commission_get_commission_plans(
...
static void
fm_mso_commission_get_commission_plans(
	pcm_context_t		*ctxp,
	int32			flags,
	pin_flist_t		*i_flistp,
	pin_flist_t		**r_flistpp,
	...
	pin_errbuf_t		*ebufp)
{
	...
	*r_flistpp		= NULL;
	 ...
	 * Insanity Check 
	 *******************************************************************/
	if (opcode != MSO_OP_COMMISSION_GET_COMMISSION_PLANS) {
		pin_set_err(ebufp, PIN_ERRLOC_FM, 
			PIN_ERRCLASS_SYSTEM_DETERMINATE,
			PIN_ERR_BAD_OPCODE, 0, 0, opcode);
		PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,
			"op_mso_commission_get_commission_plans error",
			ebufp);
		return;
	}
	...
	PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG, 
		"op_mso_commission_get_commission_plans input flist", i_flistp);
	
	/*******************************************************************
	 * Call the default implementation 
	 *******************************************************************/
	fm_mso_commission_get_commission_plans(ctxp, flags, i_flistp, r_flistpp, ebufp);
 	/***********************************************************
	 * Results.
	 ***********************************************************/
	...
	if (PIN_ERRBUF_IS_ERR(ebufp)) 
	{	
		PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,"op_mso_commission_get_commission_plans error", ebufp);
	}
	else
	{
		PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,	"op_mso_commission_get_commission_plans output flist", *r_flistpp);
	}
	return;
}
...
/*******************************************************************
 * Function: fm_mso_commission_get_commission_plans
 *
	...
	pin_errbuf_t		*ebufp)
{
	...
	char			*srch_val = NULL;
	char			template[100]="select X from /plan where F1.type like V1 " ;
	int64			db = 1;
	int32			srch_flag = 256;
	int32			srch_key  = -1;
	int32			srch_type = -1;
	...
	PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG, "fm_mso_commission_get_commission_plans input flist", i_flistp);

	if (PIN_ERRBUF_IS_ERR(ebufp))
	{
		PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR, "Error in calling fm_mso_commission_get_commission_plans", ebufp);
		goto CLEANUP;
	}
	...
	service_pdp = PIN_POID_CREATE(db, "/service/settlement/ws/outcollect", -1, ebufp);
	...
	PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG, "fm_mso_commission_get_commission_plans search flist", srch_flistp);
